...
import e.rezeda.chat.databinding.ActivityUserAuthBinding;
import e.rezeda.chat.databinding.ActivityUserLoginBinding;


public class UserAuthActivity extends AppCompatActivity {

    private UserAuthViewModel viewModel;
    ...
    private void setBinding(Bundle savedInstanceState){
        viewModel = ViewModelProviders.of(this).get(UserAuthViewModel.class);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_user_auth);
